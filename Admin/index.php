...
include("../config.inc/connect_db.php");
    ...
    $query = $conn->query("SELECT * FROM tbl_admin WHERE a_id='$id'");
  ...
  <div class="row">
    <div class="col-xs-12">
      <div class="alert alert-dismissible alert-success">
          ...
          <h3>Hi! <?php echo $username; ?>, please read the following quote below.</h3>
          <p style="font-size: 18px;" id="quotes"></p>
      </div>
    </div>
  </div>
  <div class="row">
    <div class="col-xs-12 col-md-4 col-lg-4">
      <div class="panel panel-primary text-center">
          ...
          <div style="font-size: 20px;" class="panel-body">
            <?php 
                  include("../config.inc/connect_db.php");
                  $sql = "SELECT COUNT(a_category) AS total FROM tbl_item2";
    ...
    <div class="col-xs-12 col-md-4 col-lg-4">
      <div class="panel panel-success text-center">
          ...
          <div style="font-size: 20px;" class="panel-body">
            <?php 
                  include("../config.inc/connect_db.php");
                  $sql = "SELECT COUNT(a_category) AS total FROM tbl_item2 WHERE a_category='Materials'";
                  $query = mysqli_query($conn, $sql);
                  $result = mysqli_fetch_assoc($query);
                  echo $result['total'];
             ?>
    ...
    <div class="col-xs-12 col-md-4 col-lg-4">
      <div class="panel panel-info text-center">
          ...
          <div style="font-size: 20px;" class="panel-body">
            <?php 
                  include("../config.inc/connect_db.php");
                  $sql = "SELECT COUNT(a_category) AS total FROM tbl_item2 WHERE a_category='Tools and Equipment'";
                  $query = mysqli_query($conn, $sql);
                  $result = mysqli_fetch_assoc($query);
                  echo $result['total'];
             ?>
    ...
    <div class="col-xs-12 col-md-12 col-lg-12">
      <div class="panel panel-primary text-center">
          <div class="panel-heading">
            <h3 class="panel-title">Recent Add& Update</h3>
          </div>
              ...
              <tbody>
                  ...
                  <?php 
                    include("../config.inc/connect_db.php");
                      ...
                      $sql = "SELECT * FROM tbl_item_temp ORDER BY it_date_added desc";
